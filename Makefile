...
EMCC_FLAGS := \
	...
	-s EXPORT_ES6=1 \
	-s SINGLE_FILE=1 \
	-s EXPORTED_FUNCTIONS='["_malloc","_free","_pcre2_wasm_compile","_pcre2_wasm_match","_pcre2_wasm_match_all","_pcre2_wasm_replace","_pcre2_wasm_free","_pcre2_wasm_error_message"]' \
